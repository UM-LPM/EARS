...
public class MBF extends Algorithm{
	...
	double SP = 0.8;        //Mother Power
	double SPdamp = 0.95;   //Mother Power Damping Ratio
	double Dis = 1.8;         //Amount of Dispersion Coefficient
	double Pdis = 0.2;      //Amount of Probability of Dispersion Coefficient
	int pop_size = 50;      //Population Size (Fish Numbers)
	...
	double beta = 8;        //Rouleteewheel Constant
	double gamma = 0.09;    //Crossover Rate
	...
	public MBF(int pop_size)
	{
		super();
		this.pop_size = pop_size;
		
		n_Shark = (int) (0.04 * pop_size);
		nm = (int)(0.04 * pop_size * (Math.pow(SP, -0.4321)));
	...
	private void initPopulation() throws StopCriteriaException {
		...
		NatureForce = new CichlidsSolution[pop_size];
		SharkAttack = new CichlidsSolution[pop_size];
		BestResult = new CichlidsSolution[pop_size];
