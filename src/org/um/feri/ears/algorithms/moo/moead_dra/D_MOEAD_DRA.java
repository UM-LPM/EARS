...
public class D_MOEAD_DRA extends MOEAD_DRA<Double, DoubleProblem, MOTask<Double>> {
	...
	public D_MOEAD_DRA(CrossoverOperator crossover, MutationOperator mutation, int populationSize) {
