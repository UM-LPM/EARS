...
public class I_GDE3 extends GDE3<Integer, CombinatorialProblem, IntegerMOTask> {
	...
	public I_GDE3(CrossoverOperator<Integer, IntegerMOTask, NumberSolution<Integer>> crossover, int populationSize) {
