...
public class D_PESAII extends PESAII<Double, DoubleProblem, DoubleMOTask> {
	...
	public D_PESAII(CrossoverOperator<Double, DoubleMOTask, NumberSolution<Double>> crossover, MutationOperator<Double, DoubleMOTask, NumberSolution<Double>> mutation, int populationSize, int archiveSize) {
