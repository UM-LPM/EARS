...
public class ExecuteTournamentsTest {
    ...
    //Only for testing
    static String platformDir = System.getProperty("user.dir") + File.separator + "Test environment" + File.separator + "platforma";

    static String tournamentDir = platformDir + File.separator + "tournaments";
    static String earsFolder = platformDir + File.separator + "EARS";
    ...
    static boolean runValidator = false; //runs the validator for each algorithm (only for debugging)
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            /* go through the list of all tournaments */
            for (Tournament t : tournaments) {
                ...
                /* for each submission copy the BenchmarkRunnerTemplate, replace its tags, compile and run it */
                for (Submission sub : newestSubmission.values()) {
                    ...
                    if(runValidator) {
                        String[] arguments = new String[] {algorithmDir + File.separator + algorithmName+".java", algorithmDir, earsPath};
                        Validathor.main(arguments);
                    }

                    /* check if the algorithm compiled successfully and if the benchmark was successful  */
    ...
    private static void startProcess(ProcessBuilder pb, String algorithmDir, String algorithmName, String benchmarkResultsDir) throws Exception {
        ...
        new Thread(() -> {
            ...
            if (line.length() > 0) {
                logger.log(Level.SEVERE, "Error while running process for algorithm: " + algorithmName + "\n" + line);
    ...
    private static void performRating(String benchmarkResultsDir, String benchmarkName, String benchmarkId) {
        ...
        //TODO check if all algorithms have all the problem files (get list of all problems from benchmark object)
        //add problems to benchmark
