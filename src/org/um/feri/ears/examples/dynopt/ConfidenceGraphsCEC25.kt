...
import org.um.feri.ears.examples.dynopt.benchmarks.GMPBBenchmarkCEC25DimGraph
...
fun main() {
    ...
    LetsPlotUtils.generatePlot(
        ...
        filename = "RCG_CEC2025_F10_EnvF${envFrom}T${envTo}_Demo.png"
    )
}