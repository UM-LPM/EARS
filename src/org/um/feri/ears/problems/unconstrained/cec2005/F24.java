...
public class F24 extends CEC2005Base {

    static final public String DEFAULT_FILE_DATA = "hybrid_func4_data.txt";
    static final public String DEFAULT_FILE_MX_PREFIX = "hybrid_func4_M_D";
    ...
    public F24(int d) {
        super("Rotated Hybrid Composition Function 4", d, 24);
