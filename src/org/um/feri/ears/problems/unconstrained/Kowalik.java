...
public class Kowalik extends DoubleProblem {
    ...
    private static final double[] a = new double[]{0.1957, 0.1947, 0.1735, 0.1600, 0.0844, 0.0627, 0.0456, 0.0342, 0.0323, 0.0235, 0.0246};
    private static final double[] b = new double[]{0.25, 0.5, 1, 2, 4, 6, 8, 10, 12, 14, 16};
