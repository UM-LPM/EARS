...
public final class Functions {
	...
	private static double ellips_func(List<Double> x, int nx, double[] Os, double[] Mr, int s_flag, int r_flag) /* Ellipsoidal */ {
        int i;
        double f = 0.0;
        double [] z =ShiftRotation.sr_func(x, nx, Os, Mr, 1.0, s_flag, r_flag);/*shift and rotate*/
    ...
    private static double rosenbrock_func(List<Double> x,  int nx, double[] Os, double[] Mr, int s_flag, int r_flag) /* Rosenbrock's */ {
        int i;
        double tmp1, tmp2;
        double f = 0.0;
        double [] z = ShiftRotation.sr_func(x,  nx, Os, Mr, 2.048 / 100.0, s_flag, r_flag);/*shift and rotate*/
    ...
    private static double rastrigin_func(List<Double> x, int nx, double[] Os, double[] Mr, int s_flag, int r_flag) /* Rastrigin's  */ {
        double f = 0.0;
