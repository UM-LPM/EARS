...
//Opis algoritma se začne v poglavju 2.2 Presentation of charged search system
public class CSS extends Algorithm {
	...
	public CSS(int pop, double par, double cmcr) {	
		...
		au = new Author("Tadej Klakočer", "tadej.klakocer@student.um.si");
	...
	public DoubleSolution execute(Task taskProblem) throws StopCriteriaException {
		...
		while (!taskProblem.isStopCriteria()) {
			...
			// Premakne delce, če so izven mej jih popravi z HS
			// Rule 5, 6 , 7 
			...
			// Update CM (če boljši v CPs kot v CM, zamenjaj delce v CM)
