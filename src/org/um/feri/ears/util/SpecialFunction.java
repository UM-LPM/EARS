...
public final class SpecialFunction {
    ...
    /**
     * @param variable a double value
     * @return the hyperbolic arc sine of the argument
     */
    static public double asinh(double variable) throws ArithmeticException {
        double x;
        int sign;
    ...
    /**
     * @param variable an integer value
     * @return the factorial of the argument
     */
    static public int fac(int variable) throws ArithmeticException {
        int i = variable;
        int d = 1;
        if (variable < 0) i = Math.abs(variable);
        while (i > 1) {
            d *= i--;
        }
        if (variable < 0) return -d;
        else return d;
    }
