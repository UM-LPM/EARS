 ...
 */
public class SolutionDominanceComparator implements Comparator<Solution>, Serializable {

    private final double epsilon;
    protected boolean[] objectiveMaximizationFlags;
    OverallConstraintViolationComparator violationConstraintComparator;
    public SolutionDominanceComparator() {
        this(0.0);
    }

    public SolutionDominanceComparator(double epsilon) {
