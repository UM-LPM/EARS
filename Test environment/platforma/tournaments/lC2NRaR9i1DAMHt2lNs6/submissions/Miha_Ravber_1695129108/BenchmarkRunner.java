...
public class BenchmarkRunner {
	...
	public static void main(String args[]) {
		...
		LSHADE algorithm = new LSHADE();
		RPUOed30Benchmark benchmark = new RPUOed30Benchmark(); // Create benchmark
		benchmark.initAllProblems(); //manually initialize problems
		algorithm.addCustomInfo("submissionAuthor", "Miha_Ravber");
		algorithm.addCustomInfo("submissionId", "TM0hQJiVuELlnoHAkjkn");
		
		logger.log(Level.INFO, "algorithm "+"LSHADE");
		logger.log(Level.INFO, "submission author "+"Miha_Ravber");
		logger.log(Level.INFO, "submission id "+"TM0hQJiVuELlnoHAkjkn");
